...
impl State {
    ...
    pub(super) fn transition_to_complete(&self) -> Snapshot {
        ...
        log::info!("id[{}] transition_to_complete running is {}, complete is {}",self.id,prev.is_running(),prev.is_complete());
    ...
    pub(super) fn transition_to_terminal(&self, count: usize) -> bool {
        ...
        log::info!("id[{}] transition_to_terminal ref_count is {}",self.id,prev.ref_count());
        assert!(
    ...
    pub(super) fn drop_join_handle_fast(&self) -> Result<(), ()> {
        ...
        log::info!("id[{}] drop_join_handle_fast",self.id);
        self.val
    ...
    pub(super) fn ref_inc(&self) {
        ...
        log::info!("id[{}] ref_inc prev is {prev}",self.id);
    ...
    pub(super) fn ref_dec(&self) -> bool {
        ...
        log::info!("id[{}] ref_dec ref_count is {}",self.id,prev.ref_count());
    ...
    pub(super) fn ref_dec_twice(&self) -> bool {
        ...
        log::info!("id[{}] ref_dec_twice ref_count is {}",self.id,prev.ref_count());
        ...
        F: FnMut(Snapshot) -> (T, Option<Snapshot>),
    {
        ...
        loop {
            ...
            // log::info!("state fetch_update_action res is {res:?}");
        ...
        F: FnMut(Snapshot) -> Option<Snapshot>,
    {
        ...
        loop {
            ...
            let res = self.val.compare_exchange(curr.0, next.0, AcqRel, Acquire);
            log::info!("id[{}] fetch_update res is {res:?}",self.id);
